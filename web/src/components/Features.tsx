import { BookOpen, CircleChevronDown, Bell, type LucideIcon } from "lucide-react";

const features: { icon: LucideIcon; iconColor: string; bg: string; title: string; desc: string }[] = [
  {
    icon: BookOpen,
        ...
        {features.map((f, i) => (
          ...
          >
            <div className="flex items-start gap-4">
              <div
                className={`w-11 h-11 min-w-[44px] rounded-xl ${f.bg} flex items-center justify-center`}
              >
